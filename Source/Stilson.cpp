...
void StilsonMoog::computeCutoff(float cut) {
...
void StilsonMoog::computeResonance(float res) {
...
void StilsonMoog::processSamples(float *samples, int numSamples) throw() {
